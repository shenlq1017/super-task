...
- 日志 / 指标 / 进程数据上云；
- 移动端；
- ~~网页控制台~~ → **2026-08-30 范围变更**：服务端自带的账号管理控制台已由 v2.0.1 交付，
  见 [v2.0.1 cloud admin console spec](2026-08-30-v2-0-1-cloud-admin-console-spec.md)；
  本期仍不含会话吊销、实体内容浏览、每账号配额覆盖、遥测聚合与审计表；
